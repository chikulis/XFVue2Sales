                ...
                <el-col :span="9">
                    <el-form-item label="公司编号" prop="companyid">
                        ...
                        <PrcCompany
                            ...
                            fieldname="companyid"
                            @selectData="companyidInputEnterEvent"
                        ></PrcCompany>
                    </el-form-item>
                </el-col>
            </el-row>
    ...
    methods: {
        ...
        fetchTableData() {
            ...
            this.$api.fcashdocitem
                .getDataOfFGLAccctCodeAccessList(
        ...
        inputEnterEvent() {
            ...
            this.searchform.accountid = this.str;
            this.$api.fcashdocitem
                .getDataOfFGLAccctCodeAccessList(
                    this.commEntity.pagination.pageIndex,
                    this.commEntity.pagination.pageSize,
                ...
                .then((res) => {
                    if (res.total != 1) {
                        if (res.total == 0) {
                            this.$message.warning('当前科目代码输入不正确，请检查 ！');
                            return;
                        }
                        this.tableData = res.rows;
                        this.commEntity.pagination.total = res.total;
